...
```bash
td wf secrets list                  # List secret keys (values hidden)
td wf secrets set KEY=value         # Set a secret
td wf secrets set my_project KEY=v  # Set for specific project
td wf secrets delete KEY            # Delete a secret
```
